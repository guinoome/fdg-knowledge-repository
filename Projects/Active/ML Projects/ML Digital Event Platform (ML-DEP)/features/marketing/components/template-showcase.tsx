  ...
  return (
    <section className="bg-[#f4f0e8] text-[#171713]">
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        <header className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-black/58">
              Four distinct openings are live now. Choose a world to enter,
              then replace the sample photographs with your own story.
            </p>
          </div>
          <Link
            ...
            >
              ...
              >
                <div className="flex items-start justify-between">
                  <p className="text-[9px] font-semibold uppercase tracking-[.26em] text-white/72">
                    {experience.occasion}
                  </p>
                ...
                <div>
                  ...
                  <p className="mt-4 max-w-xs text-xs leading-5 text-white/66">
                    {experience.promise}
                  </p>
        ...
        <p className="mt-12 text-[9px] uppercase tracking-[.24em] text-black/42 md:mt-16">
