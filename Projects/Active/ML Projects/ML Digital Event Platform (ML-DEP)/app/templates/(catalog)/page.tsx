    ...
    <section className="relative -mx-4 mb-12 overflow-hidden bg-[#ece6db] px-5 pb-0 pt-14 text-[#171713] md:-mx-8 md:px-10 md:pt-20">
      <div className="relative z-10 grid min-h-[32rem] gap-10 md:grid-cols-[.8fr_1.2fr] md:items-center">
        <div className="pb-12 md:pb-20">
          ...
          <p className="mt-6 max-w-md text-pretty text-sm leading-7 text-black/58">
            Every design begins with its own opening, visual language, and
            guest journey. Four are live now; more join through thoughtfully
            crafted releases.
          </p>
        </div>
