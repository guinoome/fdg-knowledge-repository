  ...
  return (
    <div className="flex min-h-screen flex-col">
          ...
          <div className="mx-auto grid max-w-7xl md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-6 py-16 md:px-14">
              ...
              <p className="mt-6 max-w-md text-sm leading-7 text-white/58">
                Open the live experiences, choose the one that feels right,
                and make it yours with your photographs, words, and event
                details.
              </p>
              <Button asChild size="lg" className="mt-9 w-fit bg-[#b3874b] text-white hover:bg-[#c99b5d]">
      ...
      <footer className="w-full bg-[#090909] px-5 py-10 text-white md:px-8">
        ...
        <p className="mt-8 border-t border-white/12 pt-6 text-xs text-white/40">
