...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#090909]/95 text-white backdrop-blur supports-[backdrop-filter]:bg-[#090909]/88">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-5 px-5 md:px-8">
        ...
        >
          {branding.shortName}
          <span className="block pt-1 font-sans text-[7px] uppercase tracking-[.34em] text-white/46">
            Printing
          </span>
        </Link>

        <nav className="hidden items-center gap-7 text-[9px] font-semibold uppercase tracking-[.22em] text-white/58 sm:flex">
          ...
          <Link href="/#experience-proofs" className="transition-colors hover:text-white">
            Experiences
          </Link>
        ...
        <div className="ml-auto flex items-center gap-2">
          {user ? (
            <Button asChild size="sm" className="bg-[#b3874b] text-white hover:bg-[#c89b5b]">
            ...
            <>
              ...
              {features.registration ? (
                <Button asChild size="sm" className="rounded-full border border-[#dfbd7e] bg-transparent text-white hover:bg-[#dfbd7e] hover:text-black">
