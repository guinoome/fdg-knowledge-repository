# FMCIS — Repository Linking Map

The existing FDG repository uses vault-relative Obsidian wikilinks and section Master Indexes. FMCIS follows that convention.

## Verified primary relationships
...
- [[01_Governance/NEX-STD-002_DOCUMENT_CONTROL|Document Control]]
- [[01_Governance/NEX-STD-003_DECISION_EVOLUTION_STANDARD|Decision Evolution Standard]]
- [[01_Governance/NEX-STD-005_CONSTITUTION|Constitution]]
...
- Add FMCIS to the Nex Master Index system map.
- Add an FMCIS relationship from the Agentic Framework.
- Add FMCIS to Organizational Architecture as an implementation of dynamic specialization/orchestration.
- Define the Nex ↔ FMCIS interface within Nex Core when Nex becomes operational.
